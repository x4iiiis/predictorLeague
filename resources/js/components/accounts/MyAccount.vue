<template>
    <div class="px-0 ml-0 mr-auto col-10 col-md-3 fixed-bottom h-100 shadow-lg" style="z-index:1"
        :class="show ? 'translate-x-0 ease-out duration-500' : '-translate-x-full ease-in duration-500'"
    >
        <div class="card h-100">
            <div class="card-header">
                <div class="row">
                    ...
                    <button type="button" class="close col-3 pr-2 text-right" data-dismiss="popup" aria-label="Close">
